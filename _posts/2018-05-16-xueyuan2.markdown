...
**到这里**，了解到transform的这些功能，我们亲爱的**box0**想变成设计稿上的那个图形就都不在话下了~不过，我还想提出一个点：div里面的文字是垂直居中的，我们可以用很多方式来实现这个效果。但既然今天我们学了transform,要不要活学活用，来一点新的尝试呢？  
...
```
>我来解释一下这段代码：top和left的值使内部容器的左上角位于其父容器的正中间。然后transform让其在对应轴上反向移动自己宽高的一般，从而达到居中的效果。
